	...
	extends AbstractResourceTest
{
	...
	{
		String result = performRestCall("securitydomain/permission/text?text=" + TestObjectContainer.PERMISSION_1_A.getPermissionText() 
				+ "&appName=" + TestObjectContainer.APP_A.getApplicationName());
