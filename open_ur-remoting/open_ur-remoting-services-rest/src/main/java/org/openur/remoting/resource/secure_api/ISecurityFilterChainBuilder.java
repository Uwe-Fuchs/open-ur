...
public interface ISecurityFilterChainBuilder<C extends Configurable<C>>
{
	...
	default void buildSecurityFilterChain(SecureApiSettings settings, C configurable)
	{
		...
		{
			case PRE_AUTH:
				buildFilterChainPreAuth(configurable);
				break;
			...
			case PERMCHECK:
				buildFilterChainPermCheck(configurable);
				break;
			...
			case PRE_AUTH_PERMCHECK:
				buildFilterChainPreAuthPermCheck(configurable);
				break;
	 ...
	 * @param configurable
	 */
	void buildFilterChainPreAuth(C configurable);
	 ...
	 * @param configurable
	 */
	void buildFilterChainPermCheck(C configurable);
