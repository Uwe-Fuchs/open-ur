...
-- This is just for JPA-purposes: --------------------------------------------------------------------------------------------
CREATE TABLE ORGANIZATIONAL_UNIT_ORG_UNIT_MEMBER (
  ORGANIZATIONAL_UNIT_ID bigint(20) NOT NULL,
  members_ID bigint(20) NOT NULL
);

ALTER TABLE ORGANIZATIONAL_UNIT_ORG_UNIT_MEMBER ADD PRIMARY KEY (ORGANIZATIONAL_UNIT_ID, members_ID);
ALTER TABLE ORGANIZATIONAL_UNIT_ORG_UNIT_MEMBER ADD FOREIGN KEY (ORGANIZATIONAL_UNIT_ID) REFERENCES ORGANIZATIONAL_UNIT (`ID`);
ALTER TABLE ORGANIZATIONAL_UNIT_ORG_UNIT_MEMBER ADD FOREIGN KEY (members_ID) REFERENCES ORG_UNIT_MEMBER (`ID`);
CREATE UNIQUE INDEX UNQ_members_ID ON ORGANIZATIONAL_UNIT_ORG_UNIT_MEMBER (members_ID);
-- ----------------------------------------------------------------------------------------------------------------------------
